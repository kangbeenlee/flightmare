...
struct SubMessage_t {
  ...
  std::vector<Sub_Target_t> sub_targets;
  std::vector<Sub_Tracker_t> sub_trackers;
};
...
inline void to_json(json &j, const Target_t &o) {
  j = json{{"ID", o.ID},
           {"position", o.position},
           {"rotation", o.rotation},
           {"size", o.size},
...
inline void to_json(json &j, const Tracker_t &o) {
  j = json{{"ID", o.ID},
           {"position", o.position},
           {"rotation", o.rotation},
           {"size", o.size},
...
inline void to_json(json &j, const SettingsMessage_t &o) {
  // j = json{{"scene_id", o.scene_id}, {"vehicles", o.vehicles}, {"objects", o.objects}};
  j = json{{"scene_id", o.scene_id}, {"targets", o.targets}, {"trackers", o.trackers}, {"objects", o.objects}};
}

// Publish messages to unity
inline void to_json(json &j, const PubMessage_t &o) {
  // j = json{{"frame_id", o.frame_id}, {"vehicles", o.vehicles}, {"objects", o.objects}};
  j = json{{"frame_id", o.frame_id}, {"targets", o.targets}, {"trackers", o.trackers}, {"objects", o.objects}};
}
...
// Publish messages to unity
inline void from_json(const json &j, Sub_Target_t &o) {
  o.collision = j.at("collision").get<bool>();
  o.lidar_ranges = j.at("lidar_ranges").get<std::vector<Scalar>>();
}

// Publish messages to unity
inline void from_json(const json &j, Sub_Tracker_t &o) {
  o.collision = j.at("collision").get<bool>();
  o.lidar_ranges = j.at("lidar_ranges").get<std::vector<Scalar>>();
}
...
inline void from_json(const json &j, SubMessage_t &o) {
  ...
  o.sub_targets = j.at("pub_targets").get<std::vector<Sub_Target_t>>();
  o.sub_trackers = j.at("pub_trackers").get<std::vector<Sub_Tracker_t>>();
}
