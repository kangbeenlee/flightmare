...
gt_range = np.array([float(line.strip()) for line in open("/home/kblee/catkin_ws/src/flightmare/flightlib/include/flightlib/data/tracking_output/gt_range.txt")])
estim_range = np.array([float(line.strip()) for line in open("/home/kblee/catkin_ws/src/flightmare/flightlib/include/flightlib/data/tracking_output/estim_range.txt")])
...
meas_u_l = np.array([float(value) for line in open("/home/kblee/catkin_ws/src/flightmare/flightlib/include/flightlib/data/tracking_output/meas_u_l.txt") for value in line.split()])
meas_v_l = np.array([float(value) for line in open("/home/kblee/catkin_ws/src/flightmare/flightlib/include/flightlib/data/tracking_output/meas_v_l.txt") for value in line.split()])
meas_u_r = np.array([float(value) for line in open("/home/kblee/catkin_ws/src/flightmare/flightlib/include/flightlib/data/tracking_output/meas_u_r.txt") for value in line.split()])
meas_v_r = np.array([float(value) for line in open("/home/kblee/catkin_ws/src/flightmare/flightlib/include/flightlib/data/tracking_output/meas_v_r.txt") for value in line.split()])
...
print(gt_x[-1], gt_y[-1], gt_z[-1])
print(estim_x[-1], estim_y[-1], estim_z[-1])
...
ax.plot(gt_x[0], gt_y[0], gt_z[0], 'o', color='orange', markersize=5, label='true initial position')
ax.plot(estim_x[0], estim_y[0], estim_z[0], 'co', markersize=5, label='estimate initial position')
ax.set_xlabel('x, m')
ax.set_ylabel('y, m')
ax.set_zlabel('z, m')
ax.legend()
...
plt.figure()
plt.plot(time, estim_range, label='estimated range')
plt.plot(time, gt_range, label='gt range')
plt.legend()
