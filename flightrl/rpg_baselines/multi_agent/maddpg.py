...
import numpy as np
import copy
from rpg_baselines.multi_agent.networks import Actor, Critic_MADDPG
import os
...
class MADDPG(object):
    ...
    def save_model(self, path, total_steps, agent_id):
        path = os.path.join(path, "step_{}k_agent_{}.pth".format(int(total_steps / 1000), agent_id))
